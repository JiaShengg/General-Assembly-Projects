...
In this project, we will approach this energy forecasting problem as a time-series regression problem with periodicity in many real system, and develop Decision Tree Ensemble models and Gated recurrent units (GRUs) models for each meter type to forecast the sequential data.
