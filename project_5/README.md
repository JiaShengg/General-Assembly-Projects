...
In this project, we will approach this energy forecasting problem as a regression problem, and develop Decision Tree Ensemble models and Gated recurrent units (GRUs) models for each meter type that strikes the right balance in the bias-variance trade off.
