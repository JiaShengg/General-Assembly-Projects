...
- [Datasets](#Datasets)
- [Significant Findings & Recommendations](#Significant-Findings-&-Recommendations)
...
## Folder Organisation
    ...
    |__ datasets
    |____ cleaned
    |    |____ cleaned_test3.csv
    |    |____ cleaned_train3.csv
    |    |____ ensembled_model.csv
    |    |____ kaggle_submission(lgbm).csv    
    |    |____ kaggle_submission(gru).csv   
    |____ raw
    |    |____ building_metadata.csv
    |    |____ EDA_test_df.csv
    |    |____ EDA_train_df.csv
    |    |____ test.csv
    |    |____ train.csv
    |    |____ test.csv
    |    |____ weather_test.csv    
    |    |____ weather_train.csv
    |__ README.md
    |__ requirements.txt
